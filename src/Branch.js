    ...
    <div className="branches-page">
      ...
      <div className="branches-container">
        <div className="branch-card">
          <h2>Tarnaka</h2>
          <p>12-13-289, St.9, Lane-2, St.Ann's School Road, Tarnaka, Hyderabad 500017 <br/> Daily 8:00am - 6:00pm <br/> 7207014049,42604049</p>
        ...
        <div className="branch-card">
          <h2>Kukatpally</h2>
          <p>H.No: 15-21-211, Balaji Nagar, Kukatpally, Hyderabad 500072 <br/> Open Daily <br/> 8:00am - 6:00pm <br/> 9000654049</p>
          <img src={kukatpally} alt="Kukatpally" />
        </div>
        <div className="branch-card">
          <h2>Dammaiguda</h2>
          <p>H.No: 9-18/5, Plot No: 13-S.Part, Sy.No: 597, Gayathri Nagar, Dammaiguda, Hyderabad <br/>Daily 8:00am - 6:00pm<br/> 9666309705</p>
          <img src={dammaiguda} alt="Dammaiguda" />
        </div>
        <div className="branch-card">
          <h2>New Nagole</h2>
          <p>Samathapuri Colony, Road No: 7, Plot No: 80, New Nagole, Hyderabad<br/> Daily 8:00am - 6:00pm<br/> 9502223850, 7207094049</p>
